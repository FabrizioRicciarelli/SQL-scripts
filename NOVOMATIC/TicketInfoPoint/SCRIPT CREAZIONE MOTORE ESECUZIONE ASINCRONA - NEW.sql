...
*/
IF OBJECT_ID('AsyncExecResults') IS NULL 
...
*/
IF EXISTS (SELECT * FROM sys.services WHERE name = N'AsyncExecService') DROP SERVICE AsyncExecService;
IF EXISTS (SELECT * FROM sys.service_queues WHERE name = N'AsyncExecQueue') DROP QUEUE AsyncExecQueue;
...
*/
IF OBJECT_ID('AsyncExecActivated') IS NOT NULL DROP PROC AsyncExecActivated;
GO
...
*/
IF OBJECT_ID('AsyncExecInvoke') IS NOT NULL DROP PROC AsyncExecInvoke;
GO
...
*/
IF OBJECT_ID('MyLongRunningProcedure') IS NOT NULL DROP PROC MyLongRunningProcedure;
GO
...
*/
IF OBJECT_ID('MyFaultyProcedure') IS NOT NULL DROP PROC MyFaultyProcedure;
GO
