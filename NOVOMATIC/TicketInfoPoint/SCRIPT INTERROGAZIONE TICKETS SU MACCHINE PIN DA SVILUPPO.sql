...
EXEC	Ticket.ExtractFromPIN
		...
		,@TicketCode = '479194386004564610,369456253604773261,525764475876923475,181340809208629093,1000294MHR201502110001' -- FACOLTATIVO, ELENCO DI TICKETS (MIXATI, SIA MHx CHE NON), SEPARATI DA VIRGOLE, IN INGRESSO 
...
ALTER PROC	Ticket.ExtractFromPIN
			...
			,@TicketCode varchar(max) = NULL -- ELENCO DI TICKETS (MIXATI, SIA MHx CHE NON), SEPARATI DA VIRGOLE, IN INGRESSO 
			,@TicketValue int
