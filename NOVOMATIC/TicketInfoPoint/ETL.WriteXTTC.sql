...
SELECT * FROM ETL.GetXTTC(@XTTC, NULL, NULL, NULL, NULL, NULL)
SELECT * FROM ETL.GetXTTC(@XTTC, '391378593917118856', NULL, NULL, NULL, NULL)
SELECT * FROM ETL.GetXTTC(@XTTC, NULL, 1, NULL, NULL, NULL)
SELECT * FROM ETL.GetXTTC(@XTTC, NULL, NULL, 1234567, NULL, NULL)
SELECT * FROM ETL.GetXTTC(@XTTC, NULL, NULL, NULL, 1233, NULL)
SELECT * FROM ETL.GetXTTC(@XTTC, NULL, NULL, NULL, NULL, 3)
SELECT * FROM ETL.GetXTTC(@XTTC, NULL, 0, NULL, NULL, 3)
	...
	AND ISNULL(@FlagCalc,-1) != -1
		BEGIN
			IF @CurrentXTTC IS NOT NULL
				BEGIN
					INSERT @inputTTC
					SELECT * FROM ETL.GetXTTC(@CurrentXTTC, NULL, NULL, NULL, NULL, NULL)
				END
