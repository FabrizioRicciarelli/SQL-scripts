...
--SELECT	'COMPARING DELTA' AS ANALYSIS, X.RowID, X.UnivocalLocationCode, X.ServerTime, X.MachineID, X.GD, X.AamsMachineCode, X.GameID, X.GameName, X.VLTCredit, X.TotalBet, X.TotalWon, X.TotalBillIn, X.TotalCoinIn, X.TotalTicketIn, X.TotalHandPay, X.TotalTicketOut, X.Tax, X.TotalIn, X.TotalOut, X.WrongFlag, X.TicketCode, X.FlagMinVltCredit, X.SessionID
--FROM	[RAW].[Delta] D
--		INNER JOIN
