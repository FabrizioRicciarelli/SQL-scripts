...
-- L'INSERIMENTO PUO' AVVENIRE SOLO UNA VOLTA AL GIORNO: ELIMINARE LE RIGHE DI CIASCUNA GIORNATA - PER TUTTI I CONCESSIONARI - PER EFFETTUARE UN INSERIMENTO AGGIORNATO
--
--DELETE 
--FROM	ETL.LogConteggi 
--WHERE	YEAR(SystemDate) = YEAR(GETDATE()) 
